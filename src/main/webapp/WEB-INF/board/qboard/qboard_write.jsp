...
<!--  css -->
<link rel="stylesheet" type="text/css" href="/quizwiki/css/qboard/qboard.css" />
<link rel="stylesheet" type="text/css" href="/quizwiki/css/qboard/style.css" />
<link rel="stylesheet" type="text/css" href="/quizwiki/css/qboard/bootstrap.css" />

<!-- js -->
<script type="text/javascript" src="/quizwiki/js/qboard/sidebar.js"></script>
<script type="text/javascript" src="/quizwiki/js/qboard/jquery-1.11.2.js"></script>
<script type="text/javascript" src="/quizwiki/js/qboard/bootstrap.js"></script>
				...
				<div id="side_menu">
					<ul>
						...
						<li class="side_select"
							onclick="location.href='/quizwiki/qboard/list'">질문게시판</li>

						<li onclick="location.href='/quizwiki/pboard/list'">나만의 문제집</li>
					</ul>
