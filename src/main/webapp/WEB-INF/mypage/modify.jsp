...
<link rel="stylesheet" type="text/css" href="/quizwiki/css/mypage/mycontentroom.css" />
<link rel="stylesheet" type="text/css" href="/quizwiki/css/mypage/modify.css" />
					...
					<div class="modify_wrapper">
						<ul class="modify_list">
							...
							<li id="userpropil"><div class="centered">
									<img src="/quizwiki/images/myphoto.jpg" id="userImage"
										style="width: 100px">
								</div>
								<div>
